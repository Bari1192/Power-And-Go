...
class Szemely{
    ...
    public function __construct(string $jogositvany_szama, \DateTime $jogositvany_ervenyesseg, \DateTime $jogositvany_lejarata, string $V_nev, string $K_nev, string $Szig_szam, string $felh_jelszo, \DateTime $szul_datum, string $telefon, string $email)
    {
