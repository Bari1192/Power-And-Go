<template>
    <table class="m-auto w-3/4 border-2 border-sky-300 border-collapse">
        <thead>
        ...
        <tbody class=" text-white text-lg">
            <tr v-for="car in cars" :key="car.autok_id" class=" text-white cursor-pointer odd:hover:bg-sky-900 even:hover:bg-sky-800 odd:bg-sky-500  even:bg-sky-600">
