    ...
    public function run(): void
    {
        DB::table('flotta_tipusok')->insert(
            [
                ...
                ['gyarto' => 'Renault', 'tipus' => 'Kangoo-Z.E.', 'teljesitmeny' => 33, 'vegsebesseg' => 130, 'gumimeret' => '165|65-R15', 'hatotav' => 285, 'created_at' => now(), 'updated_at' => now()],
                ['gyarto' => 'Opel', 'tipus' => 'Vivaro-e', 'teljesitmeny' => 75, 'vegsebesseg' => 192, 'gumimeret' => '165|65-R16', 'hatotav' => 320, 'created_at' => now(), 'updated_at' => now()],
