...
class NapiBerlesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($arazasok->isEmpty()) {
            $this->command->info('Nincsenek árazási adatok az adatbázisban!');
            return;
        }
    ...
    private function napiBerlesAutokEsElofizAlapjan($auto_besorolas, $elofiz_azon)
    {
        ...
        $napiarak = [
            ...
            1 => [
                ...
                # 2-es [Renault Kangoo - 33 kW] típus
                2 => [
                    47360,
                    71040,
                    94720,
        ...
        return $napiarak[$auto_besorolas][$elofiz_azon] ?? [];
    }
}
